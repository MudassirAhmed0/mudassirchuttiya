...
const Footer = () => {
  return (
    <>
      <div className='why-background pt-5r pb-5r ipad-pr-3r ipad-pl-3r'>
            ...
            <div className='flex space-between mt-1r'>
              <div className='w-36 mob-w-48'>
                <ul className=' flex direction-column row-gap-1'>
                  <li><Link to={'/services/smm'} className='text-decoration p-color'>Social Media Marketing and Management</Link></li>
